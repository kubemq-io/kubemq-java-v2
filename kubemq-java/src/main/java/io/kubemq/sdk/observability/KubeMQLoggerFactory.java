 ...
 * Resolution order:
 * <ol>
 *   <li>User-provided logger via client builder (always wins)</li>
 *   <li>SLF4J adapter if SLF4J is on the classpath (backward-compatible default)</li>
 *   <li>NoOpLogger (silent default when no logging framework is present)</li>
 * </ol>
 */
