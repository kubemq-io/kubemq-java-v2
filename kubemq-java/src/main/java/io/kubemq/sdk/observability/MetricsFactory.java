 ...
 *
 * <p>Uses {@link Class#forName(String)} to load {@code KubeMQMetrics} only when OTel API is
 * confirmed available on the classpath. Falls back to {@link NoOpMetrics} when OTel is absent (per
 * J-11 constraint).
 */
public final class MetricsFactory {
  ...
  public static Metrics create(
      Object meterProvider, String sdkVersion, CardinalityConfig cardinalityConfig) {
    ...
    try {
      return (Metrics)
          Class.forName("io.kubemq.sdk.observability.KubeMQMetrics")
