...
/**
 * Abstraction for SDK tracing operations. Client code uses this interface exclusively; the
 * OTel-importing implementation ({@code KubeMQTracing}) is loaded only when OTel is confirmed
 * available on the classpath.
 *
 * <p>All OTel-specific types are represented as {@code Object} to avoid {@code
 * NoClassDefFoundError} when OTel is absent.
 */
public interface Tracing {
   ...
   */
  Object startLinkedConsumerSpan(
      String operationName, String channel, String messageId, Object producerContext);
   ...
   * @return started span as Object
   */
  Object startBatchReceiveSpan(String channel, int messageCount, List<?> producerContexts);
