 ...
 * <p>
 * Uses {@link Class#forName(String)} to load {@code KubeMQTracing} only when
 * OTel API is confirmed available on the classpath. Falls back to
 * {@link NoOpTracing} when OTel is absent (per J-11 constraint).
 */
public final class TracingFactory {
     ...
     */
    public static Tracing create(Object tracerProvider, String sdkVersion,
