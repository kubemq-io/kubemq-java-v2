...
public class PubSubStats {
  ...
  /**
   * Returns a string representation of the Pub/Sub statistics. The string includes the number of
   * messages, the volume of data, the number of waiting, expired, delayed, and responses.
   *
