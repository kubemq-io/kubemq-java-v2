...
public class QueueMessageWaitingPulled {
   ...
   * @return the result
   */
  public static QueueMessageWaitingPulled decode(QueueMessage message, String receiverClientId) {
    ...
    received.timestamp =
        Instant.ofEpochSecond(message.getAttributes().getTimestamp() / 1_000_000_000L);
