...
/**
 * QueuesChannel represents a channel in KubeMQ for queuing messages. It contains details about the
 * channel's name, type, last activity time, status, and statistics for incoming and outgoing
 * messages.
 */
@Getter
@Setter
...
public class QueuesChannel {
   ...
   *
   * @return A string representing the name, type, last activity, status, incoming, and outgoing
