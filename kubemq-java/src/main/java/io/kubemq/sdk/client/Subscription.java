 ...
 *
 * <p><b>Thread Safety:</b> This class is thread-safe. {@link #cancel()} and {@link #cancelAsync()}
 * can be called from any thread. Cancellation is idempotent.
 *
 * <p>Example usage:
 *
 * <pre>{@code
...
public class Subscription {
  ...
  /** Cancel the subscription synchronously. Idempotent -- calling multiple times is safe. */
  public void cancel() {
