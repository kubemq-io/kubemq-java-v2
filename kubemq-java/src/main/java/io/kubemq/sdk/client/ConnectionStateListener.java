...
/**
 * Listener for connection state transitions. All methods have default no-op implementations,
 * allowing users to override only the events they care about.
 *
 * <p>Listeners are invoked asynchronously on a dedicated executor and must not block the
 * connection.
 */
