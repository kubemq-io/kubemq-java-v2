 ...
 *
 * <p>All parameters have sensible defaults and are configurable via the builder.
 */
@Getter
@Builder
public class ReconnectionConfig {
  ...
  @Builder.Default private final long initialReconnectDelayMs = 500;

  /** Maximum delay between reconnection attempts. Default: 30_000ms (30s). */
  @Builder.Default private final long maxReconnectDelayMs = 30_000;
  ...
  @Builder.Default private final boolean reconnectJitterEnabled = true;

  /** Maximum size of the reconnection message buffer in bytes. Default: 8MB. */
  @Builder.Default private final long reconnectBufferSizeBytes = 8 * 1024 * 1024;
