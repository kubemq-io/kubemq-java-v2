 ...
 *
 * <p>The SDK performs a non-blocking compatibility check on first operation,
 * logging a warning if the server version falls outside the tested range.
 * The connection always proceeds regardless of the result.</p>
 *
 * @see KubeMQVersion
 */
public final class CompatibilityConfig {
     ...
     * maintaining a duplicate hardcoded constant.
     */
     ...
     *
     * <p>Pre-release suffixes (e.g., "-beta", "-rc.1") are stripped before
     * parsing. A leading 'v' prefix is also stripped.</p>
     */
