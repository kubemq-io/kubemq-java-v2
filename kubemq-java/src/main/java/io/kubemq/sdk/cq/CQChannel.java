...
/**
 * CQChannel represents a channel in a KubeMQ system. It contains information about the channel's
 * name, type, activity status, and statistics.
 */
@Getter
@Setter
@Builder
...
public class CQChannel {
   ...
   *
   * @return A string representing the channel's name, type, last activity time, active status, and
   *     statistics.
   */
  @Override
