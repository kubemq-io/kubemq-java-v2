...
/**
 * Defines the low-level communication contract with the KubeMQ server.
 * This is the only layer that imports gRPC packages.
 *
 * <p>Package-private: not part of the public API. Clients interact with
 * the SDK through {@code PubSubClient}, {@code QueuesClient}, and
 * {@code CQClient}, which delegate to this interface internally.</p>
 */
