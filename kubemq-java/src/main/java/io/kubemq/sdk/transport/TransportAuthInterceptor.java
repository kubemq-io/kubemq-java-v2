 ...
 *
 * <p>The token is read via a {@link Supplier} on every call, supporting mutable tokens and
 * credential providers without re-creating the interceptor or the gRPC channel.
 */
