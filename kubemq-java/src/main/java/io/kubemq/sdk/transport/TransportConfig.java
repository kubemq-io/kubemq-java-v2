 ...
 * Contains no gRPC types -- pure Java configuration.
 *
 * <p>The {@code tokenSupplier} enables dynamic token retrieval per-call
 * without leaking gRPC's {@code ClientInterceptor} type into the public API.</p>
 */
@Getter
@Builder
