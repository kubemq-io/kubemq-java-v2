 ...
 *
 * <p>Configuration options (via environment variables or system properties): - KUBEMQ_ADDRESS:
 * KubeMQ server address (default: localhost:50000) - KUBEMQ_AUTH_TOKEN: Optional authentication
 * token
 *
 * <p>For CI/CD with Testcontainers, override getKubeMQAddress() in subclass.
 */
...
public abstract class BaseIntegrationTest {
  ...
  /**
   * Verifies KubeMQ server is reachable before running tests. Override in subclass for custom
   * verification.
   */
