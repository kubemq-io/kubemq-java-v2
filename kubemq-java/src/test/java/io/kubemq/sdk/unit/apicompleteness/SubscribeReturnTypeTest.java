...
class SubscribeReturnTypeTest {
    ...
    void subscribeToEvents_returnsSubscription() {
        ...
        EventsSubscription input = EventsSubscription.builder()
    ...
    void subscribeToEventsStore_returnsSubscription() {
        ...
        EventsStoreSubscription input = EventsStoreSubscription.builder()
                .channel("test-channel")
    ...
    void subscribeToCommands_returnsSubscription() {
        ...
        CommandsSubscription input = CommandsSubscription.builder()
                .channel("test-channel")
    ...
    void subscribeToQueries_returnsSubscription() {
        ...
        QueriesSubscription input = QueriesSubscription.builder()
                .channel("test-channel")
