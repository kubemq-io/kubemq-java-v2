...
class EventMessageTest {
  ...
  class ValidationTests {
    ...
    void validate_withValidMessage_passes() {
      EventMessage msg =
          EventMessage.builder().channel("test-channel").body("test body".getBytes()).build();
    ...
    void validate_withMetadataOnly_passes() {
      EventMessage msg =
          EventMessage.builder().channel("test-channel").metadata("test metadata").build();
    ...
    void validate_withTagsOnly_passes() {
      ...
      EventMessage msg = EventMessage.builder().channel("test-channel").tags(tags).build();
    ...
    void validate_withNullChannel_throws() {
      EventMessage msg = EventMessage.builder().body("test".getBytes()).build();
    ...
    void validate_withEmptyChannel_throws() {
      EventMessage msg = EventMessage.builder().channel("").body("test".getBytes()).build();
    ...
    void validate_withNoContent_throws() {
      EventMessage msg = EventMessage.builder().channel("test-channel").build();
  ...
  class EncodingTests {
    ...
    void encode_setsClientId() {
      EventMessage msg =
          EventMessage.builder().channel("test-channel").body("test".getBytes()).build();
    ...
    void encode_setsChannel() {
      EventMessage msg = EventMessage.builder().channel("events").body("test".getBytes()).build();
    ...
    void encode_setsBody() {
      ...
      EventMessage msg = EventMessage.builder().channel("test-channel").body(body).build();
    ...
    void encode_setsTags() {
      ...
      EventMessage msg =
          EventMessage.builder().channel("test-channel").body("test".getBytes()).tags(tags).build();
    ...
    void encode_withEmptyTags_doesNotThrowNPE() {
      EventMessage msg =
          new EventMessage(
              null, "test-channel", null, "test".getBytes(), new java.util.HashMap<>());
  ...
  class RoundTripTests {
    ...
    void encodeAndDecode_preservesBody() {
      ...
      EventMessage original = EventMessage.builder().channel("test-channel").body(body).build();
