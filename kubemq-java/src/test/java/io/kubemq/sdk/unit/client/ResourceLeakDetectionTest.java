 ...
 * 2. SDK thread leaks: filter by thread name prefix "kubemq-"
 * 3. Deadlock detection: ThreadMXBean.findDeadlockedThreads()
 */
...
class ResourceLeakDetectionTest {
    ...
    void pubSubClient_afterClose_noLeakedSdkThreads() throws InterruptedException {
        ...
        assertTrue(threadsAfter.isEmpty(),
            "Leaked SDK threads after PubSubClient close: " + threadsAfter);
    }
    ...
    void queuesClient_afterClose_noLeakedSdkThreads() throws InterruptedException {
        ...
        assertTrue(threadsAfter.isEmpty(),
            "Leaked SDK threads after QueuesClient close: " + threadsAfter);
    }
    ...
    void cqClient_afterClose_noLeakedSdkThreads() throws InterruptedException {
        ...
        assertTrue(threadsAfter.isEmpty(),
            "Leaked SDK threads after CQClient close: " + threadsAfter);
    }
    ...
    void channel_isShutdownAfterClose() {
        ...
        assertTrue(client.getManagedChannel().isShutdown(),
            "ManagedChannel must be shutdown after close()");
    }
