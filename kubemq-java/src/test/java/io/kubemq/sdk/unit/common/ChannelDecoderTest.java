...
class ChannelDecoderTest {
  ...
  class QueuesChannelDecodingTests {
    ...
    void decodeQueuesChannelList_withValidJson_parsesCorrectly() throws IOException {
      String json =
          "[{\"name\":\"channel1\",\"type\":\"type1\",\"lastActivity\":1622014799,\"isActive\":true,\"incoming\":{\"messages\":100,\"volume\":200,\"waiting\":10,\"expired\":5,\"delayed\":2},\"outgoing\":{\"messages\":150,\"volume\":300,\"waiting\":8,\"expired\":3,\"delayed\":1}}]";
    ...
    void decodeQueuesChannelList_withMultipleChannels_parsesAll() throws IOException {
      String json =
          "[{\"name\":\"channel1\",\"type\":\"type1\",\"lastActivity\":1622014799,\"isActive\":true,\"incoming\":{\"messages\":100,\"volume\":200},\"outgoing\":{\"messages\":150,\"volume\":300}},{\"name\":\"channel2\",\"type\":\"type2\",\"lastActivity\":1622014800,\"isActive\":false,\"incoming\":{\"messages\":50,\"volume\":100},\"outgoing\":{\"messages\":75,\"volume\":150}}]";
      byte[] dataBytes = json.getBytes(StandardCharsets.UTF_8);
    ...
    void decodeQueuesChannelList_withUnknownFields_throwsException() {
      ...
      String json =
          "[{\"name\":\"channel1\",\"unknownField\":\"value\",\"type\":\"type1\",\"lastActivity\":1622014799,\"isActive\":true}]";
      byte[] dataBytes = json.getBytes(StandardCharsets.UTF_8);
  ...
  class PubSubChannelDecodingTests {
    ...
    void decodePubSubChannelList_withValidJson_parsesCorrectly() throws IOException {
      String json =
          "[{\"name\":\"channel1\",\"type\":\"type1\",\"lastActivity\":1622014799,\"isActive\":true,\"incoming\":{\"messages\":100,\"volume\":200},\"outgoing\":{\"messages\":150,\"volume\":300}}]";
      byte[] dataBytes = json.getBytes(StandardCharsets.UTF_8);
    ...
    void decodePubSubChannelList_withNullStats_handlesGracefully() throws IOException {
      String json =
          "[{\"name\":\"channel1\",\"type\":\"type1\",\"lastActivity\":1622014799,\"isActive\":true}]";
      byte[] dataBytes = json.getBytes(StandardCharsets.UTF_8);
  ...
  class EdgeCaseTests {
    ...
    void decode_withSpecialCharactersInName_parsesCorrectly() throws IOException {
      String json =
          "[{\"name\":\"channel-with-special_chars.123\",\"type\":\"type1\",\"lastActivity\":1622014799,\"isActive\":true}]";
      byte[] dataBytes = json.getBytes(StandardCharsets.UTF_8);
    ...
    void decode_withUnicodeCharactersInName_parsesCorrectly() throws IOException {
      String json =
          "[{\"name\":\"channel-\u00e9\u00e8\u00ea\",\"type\":\"type1\",\"lastActivity\":1622014799,\"isActive\":true}]";
      byte[] dataBytes = json.getBytes(StandardCharsets.UTF_8);
    ...
    void decode_withLargeNumbers_parsesCorrectly() throws IOException {
      String json =
          "[{\"name\":\"channel1\",\"type\":\"type1\",\"lastActivity\":9223372036854775807,\"isActive\":true,\"incoming\":{\"messages\":2147483647,\"volume\":2147483647}}]";
      byte[] dataBytes = json.getBytes(StandardCharsets.UTF_8);
    ...
    void decode_withZeroValues_parsesCorrectly() throws IOException {
      String json =
          "[{\"name\":\"channel1\",\"type\":\"type1\",\"lastActivity\":0,\"isActive\":false,\"incoming\":{\"messages\":0,\"volume\":0},\"outgoing\":{\"messages\":0,\"volume\":0}}]";
      byte[] dataBytes = json.getBytes(StandardCharsets.UTF_8);
