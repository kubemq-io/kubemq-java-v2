...
class EventStoreMessageTest {
  ...
  class ValidationTests {
    ...
    void validate_withValidMessage_passes() {
      EventStoreMessage msg =
          EventStoreMessage.builder().channel("test-channel").body("test body".getBytes()).build();
    ...
    void validate_withMetadataOnly_passes() {
      EventStoreMessage msg =
          EventStoreMessage.builder().channel("test-channel").metadata("test metadata").build();
    ...
    void validate_withTagsOnly_passes() {
      ...
      EventStoreMessage msg =
          EventStoreMessage.builder().channel("test-channel").tags(tags).build();
    ...
    void validate_withNullChannel_throws() {
      EventStoreMessage msg = EventStoreMessage.builder().body("test".getBytes()).build();
    ...
    void validate_withEmptyChannel_throws() {
      EventStoreMessage msg =
          EventStoreMessage.builder().channel("").body("test".getBytes()).build();
    ...
    void validate_withNoContent_throws() {
      EventStoreMessage msg = EventStoreMessage.builder().channel("test-channel").build();
  ...
  class EncodingTests {
    ...
    void encode_setsClientId() {
      EventStoreMessage msg =
          EventStoreMessage.builder().channel("test-channel").body("test".getBytes()).build();
    ...
    void encode_setsChannel() {
      EventStoreMessage msg =
          EventStoreMessage.builder().channel("events-store").body("test".getBytes()).build();
    ...
    void encode_setsBody() {
      ...
      EventStoreMessage msg =
          EventStoreMessage.builder().channel("test-channel").body(body).build();
    ...
    @Test
    void encode_withNullTags_viaConstructor_doesNotThrowNPE() {
      EventStoreMessage msg =
          new EventStoreMessage(null, "test-channel", null, "test".getBytes(), null);
