...
/**
 * Tests for TLS configuration in KubeMQClient. Tests cover TLS initialization paths, certificate
 * handling, and SSL exceptions.
 */
class KubeMQClientTLSTest {
  ...
  class TLSErrorPathTests {
    ...
    void builder_withTlsEnabled_invalidCert_throwsRuntimeException() throws IOException {
      ...
      assertTrue(
          ex.getMessage().contains("does not contain valid certificates") || ex.getCause() != null);
    }
