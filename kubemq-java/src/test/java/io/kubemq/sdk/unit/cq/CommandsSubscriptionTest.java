...
class CommandsSubscriptionTest {
  ...
  @Mock private CQClient mockClient;
  ...
  class ValidationTests {
    ...
    void validate_withEmptyChannel_throws() {
      CommandsSubscription subscription =
          CommandsSubscription.builder().channel("").onReceiveCommandCallback(cmd -> {}).build();
    ...
    void validate_withNullCallback_throws() {
      CommandsSubscription subscription =
          CommandsSubscription.builder().channel("test-channel").build();
  ...
  class EncodeTests {
    ...
    void encode_createsValidSubscribeRequest() {
      ...
      assertEquals(
          Kubemq.Subscribe.SubscribeType.Commands, subscribeRequest.getSubscribeTypeData());
    }
