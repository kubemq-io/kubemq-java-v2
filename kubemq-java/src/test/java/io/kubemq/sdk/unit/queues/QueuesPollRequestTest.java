...
class QueuesPollRequestTest {
  ...
  class ValidationTests {
    ...
    void validate_withDefaultValues_passes() {
      QueuesPollRequest request = QueuesPollRequest.builder().channel("test-channel").build();
    ...
    void validate_withNullChannel_throws() {
      QueuesPollRequest request = QueuesPollRequest.builder().pollMaxMessages(10).build();
    ...
    void validate_withEmptyChannel_throws() {
      QueuesPollRequest request =
          QueuesPollRequest.builder().channel("").pollMaxMessages(10).build();
    ...
    void validate_withZeroMaxMessages_throws() {
      QueuesPollRequest request =
          QueuesPollRequest.builder().channel("test-channel").pollMaxMessages(0).build();
    ...
    void validate_withNegativeMaxMessages_throws() {
      QueuesPollRequest request =
          QueuesPollRequest.builder().channel("test-channel").pollMaxMessages(-1).build();
    ...
    void validate_withZeroTimeout_throws() {
      QueuesPollRequest request =
          QueuesPollRequest.builder().channel("test-channel").pollWaitTimeoutInSeconds(0).build();
    ...
    void validate_withNegativeTimeout_throws() {
      QueuesPollRequest request =
          QueuesPollRequest.builder().channel("test-channel").pollWaitTimeoutInSeconds(-1).build();
    ...
    void validate_withNegativeVisibility_throws() {
      QueuesPollRequest request =
          QueuesPollRequest.builder().channel("test-channel").visibilitySeconds(-1).build();
    ...
    void validate_withAutoAckAndVisibility_throws() {
      ...
      ValidationException ex = assertThrows(ValidationException.class, request::validate);
      assertTrue(
          ex.getMessage().contains("autoAckMessages")
              && ex.getMessage().contains("visibilitySeconds"));
    }

    @Test
    void validate_withAutoAckOnly_passes() {
      QueuesPollRequest request =
          QueuesPollRequest.builder().channel("test-channel").autoAckMessages(true).build();
    ...
    void validate_withVisibilityOnly_passes() {
      QueuesPollRequest request =
          QueuesPollRequest.builder().channel("test-channel").visibilitySeconds(30).build();
  ...
  class EncodingTests {
    ...
    void encode_setsChannel() {
      QueuesPollRequest request = QueuesPollRequest.builder().channel("orders").build();
    ...
    void encode_setsMaxItems() {
      QueuesPollRequest request =
          QueuesPollRequest.builder().channel("test-channel").pollMaxMessages(25).build();
    ...
    void encode_convertsTimeoutToMilliseconds() {
      QueuesPollRequest request =
          QueuesPollRequest.builder().channel("test-channel").pollWaitTimeoutInSeconds(30).build();
