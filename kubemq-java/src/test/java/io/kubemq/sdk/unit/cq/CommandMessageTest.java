...
class CommandMessageTest {
  ...
  class ValidationTests {
    ...
    void validate_withTagsOnly_passes() {
      ...
      CommandMessage msg =
          CommandMessage.builder().channel("test-channel").tags(tags).timeoutInSeconds(30).build();
    ...
    void validate_withNullChannel_throws() {
      CommandMessage msg =
          CommandMessage.builder().body("test".getBytes()).timeoutInSeconds(30).build();
    ...
    void validate_withEmptyChannel_throws() {
      CommandMessage msg =
          CommandMessage.builder().channel("").body("test".getBytes()).timeoutInSeconds(30).build();
    ...
    void validate_withNoContent_throws() {
      CommandMessage msg =
          CommandMessage.builder().channel("test-channel").timeoutInSeconds(30).build();
  ...
  class EncodingTests {
    ...
    void encode_setsBody() {
      ...
      CommandMessage msg =
          CommandMessage.builder().channel("test-channel").body(body).timeoutInSeconds(30).build();
    ...
    @Test
    void encode_withNullTags_doesNotThrowNPE() {
      CommandMessage msg =
          new CommandMessage(null, "test-channel", null, "test".getBytes(), null, 30);
