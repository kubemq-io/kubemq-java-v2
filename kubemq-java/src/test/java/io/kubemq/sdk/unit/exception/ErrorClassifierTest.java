...
class ErrorClassifierTest {
  ...
  void shouldRetry_returnsFalseForNonRetryableException() {
    KubeMQException ex = AuthenticationException.builder().message("Invalid token").build();
  ...
  void shouldUseExtendedBackoff_trueForThrottling() {
    KubeMQException ex = ThrottlingException.builder().message("Rate limited").build();
  ...
  void shouldUseExtendedBackoff_falseForOtherCategories() {
    KubeMQException ex = ConnectionException.builder().message("Unavailable").build();
  ...
  void toOtelErrorType_mapsTransientToLowercase() {
    KubeMQException ex = ConnectionException.builder().message("test").build();
  ...
  void toOtelErrorType_mapsAuthenticationToLowercase() {
    KubeMQException ex = AuthenticationException.builder().message("test").build();
  ...
  void toOtelErrorType_mapsTimeoutToLowercase() {
    KubeMQException ex = KubeMQTimeoutException.builder().message("test").build();
  ...
  void toOtelErrorType_mapsThrottlingToLowercase() {
    KubeMQException ex = ThrottlingException.builder().message("test").build();
  ...
  void toOtelErrorType_allCategoriesMapped() {
    for (ErrorCategory cat : ErrorCategory.values()) {
      KubeMQException ex = KubeMQException.newBuilder().message("test").category(cat).build();
