...
class QueuesChannelTest {
  ...
  class BuilderTests {
    ...
    void builder_withMinimalFields_createsChannel() {
      QueuesChannel channel = QueuesChannel.builder().name("minimal-queue").build();
    ...
    void builder_withStats_setsStats() {
      QueuesStats stats =
          QueuesStats.builder().messages(50).volume(2500).waiting(5).expired(2).delayed(1).build();

      QueuesChannel channel = QueuesChannel.builder().name("stats-queue").incoming(stats).build();
  ...
  class ToStringTests {
    ...
    void toString_withNullStats_handlesGracefully() {
      QueuesChannel channel = QueuesChannel.builder().name("no-stats").type("queues").build();
