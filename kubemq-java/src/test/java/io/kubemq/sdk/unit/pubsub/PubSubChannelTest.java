...
class PubSubChannelTest {
  ...
  class BuilderTests {
    ...
    void builder_withMinimalFields_createsChannel() {
      PubSubChannel channel = PubSubChannel.builder().name("minimal-channel").build();
    ...
    void builder_withStats_setsStats() {
      ...
      PubSubChannel channel = PubSubChannel.builder().name("stats-channel").incoming(stats).build();
  ...
  class ToStringTests {
    ...
    void toString_withNullStats_handlesGracefully() {
      PubSubChannel channel = PubSubChannel.builder().name("no-stats").type("events_store").build();
