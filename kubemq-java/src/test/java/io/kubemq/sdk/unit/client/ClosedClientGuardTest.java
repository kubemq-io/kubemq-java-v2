...
/**
 * Tests that every operation on a closed client throws ClientClosedException. Validates
 * ensureNotClosed() guard on all three client types per REQ-TEST-1 AC-7.
 */
...
class ClosedClientGuardTest {
  ...
  class PubSubClientTests {
    ...
    private PubSubClient createAndClose() {
      PubSubClient client =
          PubSubClient.builder().address("localhost:50000").clientId("closed-guard-pubsub").build();
      client.close();
      return client;
    }
      ...
      assertThrows(
          ...
          () ->
              client.sendEventsMessage(
                  EventMessage.builder().channel("test-ch").body("data".getBytes()).build()));
    }
      ...
      assertThrows(
          ...
          () ->
              client.sendEventsStoreMessage(
                  EventStoreMessage.builder().channel("test-ch").body("data".getBytes()).build()));
    }
    ...
    void createEventsChannel_afterClose_throwsClientClosedException() {
      ...
      assertThrows(ClientClosedException.class, () -> client.createEventsChannel("test-ch"));
    }
    ...
    void deleteEventsChannel_afterClose_throwsClientClosedException() {
      ...
      assertThrows(ClientClosedException.class, () -> client.deleteEventsChannel("test-ch"));
    }
    ...
    void listEventsChannels_afterClose_throwsClientClosedException() {
      ...
      assertThrows(ClientClosedException.class, () -> client.listEventsChannels("*"));
    }
  }
  ...
  class QueuesClientTests {
    ...
    private QueuesClient createAndClose() {
      QueuesClient client =
          QueuesClient.builder().address("localhost:50000").clientId("closed-guard-queues").build();
      client.close();
      return client;
    }
    ...
    void sendQueueMessage_afterClose_throwsClientClosedException() {
      ...
      assertThrows(
          ClientClosedException.class,
          () ->
              client.sendQueueMessage(
                  QueueMessage.builder().channel("test-q").body("data".getBytes()).build()));
    }
    ...
    void createQueuesChannel_afterClose_throwsClientClosedException() {
      ...
      assertThrows(ClientClosedException.class, () -> client.createQueuesChannel("test-q"));
    }
    ...
    void deleteQueuesChannel_afterClose_throwsClientClosedException() {
      ...
      assertThrows(ClientClosedException.class, () -> client.deleteQueuesChannel("test-q"));
    }
    ...
    void listQueuesChannels_afterClose_throwsClientClosedException() {
      ...
      assertThrows(ClientClosedException.class, () -> client.listQueuesChannels("*"));
    }
  }
  ...
  class CQClientTests {
    ...
    private CQClient createAndClose() {
      CQClient client =
          CQClient.builder().address("localhost:50000").clientId("closed-guard-cq").build();
      client.close();
      return client;
    }
    ...
    void createCommandsChannel_afterClose_throwsClientClosedException() {
      ...
      assertThrows(ClientClosedException.class, () -> client.createCommandsChannel("test-cmd"));
    }
    ...
    void listCommandsChannels_afterClose_throwsClientClosedException() {
      ...
      assertThrows(ClientClosedException.class, () -> client.listCommandsChannels("*"));
    }
  }
  ...
  class IdempotentCloseTests {
    ...
    void cqClient_close_calledTwice_doesNotThrow() {
      CQClient client =
          CQClient.builder().address("localhost:50000").clientId("idempotent-close-cq").build();
      client.close();
      assertDoesNotThrow(client::close);
    }
    ...
    void close_setsIsClosedToTrue() {
      PubSubClient client =
          PubSubClient.builder().address("localhost:50000").clientId("is-closed-check").build();
