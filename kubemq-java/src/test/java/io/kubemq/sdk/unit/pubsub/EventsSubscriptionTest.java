...
class EventsSubscriptionTest {
  ...
  @Mock private PubSubClient mockClient;
  ...
  class ValidationTests {
    ...
    void validate_withNullChannel_throws() {
      EventsSubscription subscription =
          EventsSubscription.builder().onReceiveEventCallback(event -> {}).build();

      ValidationException ex = assertThrows(ValidationException.class, subscription::validate);
    ...
    void validate_withEmptyChannel_throws() {
      EventsSubscription subscription =
          EventsSubscription.builder().channel("").onReceiveEventCallback(event -> {}).build();
    ...
    void validate_withNullCallback_throws() {
      EventsSubscription subscription =
          EventsSubscription.builder().channel("test-channel").build();
    ...
    void validate_withErrorCallbackOnly_throws() {
      EventsSubscription subscription =
          EventsSubscription.builder().channel("test-channel").onErrorCallback(error -> {}).build();
