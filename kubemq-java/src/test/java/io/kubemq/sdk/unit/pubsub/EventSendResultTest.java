...
class EventSendResultTest {
  ...
  class BuilderTests {
    ...
    void builder_withAllFields_createsResult() {
      EventSendResult result =
          EventSendResult.builder().id("event-123").sent(true).error("").build();
    ...
    void builder_withError_createsResultWithError() {
      EventSendResult result =
          EventSendResult.builder().id("event-456").sent(false).error("Connection failed").build();
  ...
  class DecodeTests {
    ...
    void decode_withEmptyEventId_handlesGracefully() {
      Kubemq.Result protoResult =
          Kubemq.Result.newBuilder().setEventID("").setSent(true).setError("").build();
  ...
  class ToStringTests {
    ...
    void toString_includesAllFields() {
      EventSendResult result =
          EventSendResult.builder().id("event-789").sent(true).error("none").build();
    ...
    void toString_withNullError_handlesGracefully() {
      EventSendResult result =
          EventSendResult.builder().id("event-000").sent(false).error(null).build();
