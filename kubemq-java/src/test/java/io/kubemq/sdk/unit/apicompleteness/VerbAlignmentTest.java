...
/**
 * Tests for REQ-DX-3: Consistent verb alignment across SDKs.
 * Verifies that verb-aligned alias methods exist and old methods are deprecated.
 */
class VerbAlignmentTest {
    ...
    class PubSubClientVerbTests {
        ...
        void sendEventsStoreMessage_isDeprecated() throws NoSuchMethodException {
            Method method = PubSubClient.class.getMethod("sendEventsStoreMessage", EventStoreMessage.class);
            Deprecated annotation = method.getAnnotation(Deprecated.class);
        ...
        void subscribeToEventsStore_notDeprecated() throws NoSuchMethodException {
            Method method = PubSubClient.class.getMethod("subscribeToEventsStore", EventsStoreSubscription.class);
            assertNull(method.getAnnotation(Deprecated.class),
    ...
    class QueuesClientVerbTests {
        ...
        void receiveQueuesMessages_isDeprecated() throws NoSuchMethodException {
            Method method = QueuesClient.class.getMethod("receiveQueuesMessages", QueuesPollRequest.class);
            Deprecated annotation = method.getAnnotation(Deprecated.class);
    ...
    class CQClientVerbTests {
        ...
        void sendCommand_convenienceExists() throws NoSuchMethodException {
            Method method = CQClient.class.getMethod("sendCommand", String.class, byte[].class, int.class);
            assertNotNull(method);
            assertEquals(CommandResponseMessage.class, method.getReturnType());
        }
    ...
    class CompleteMappingTests {
        ...
        void allAliasMethodsExist() {
            assertDoesNotThrow(() -> {
                ...
                assertNotDeprecated(QueuesClient.class, "receiveQueueMessages", QueuesPollRequest.class);
        ...
        private void assertDeprecated(Class<?> clazz, String methodName, Class<?>... paramTypes)
            ...
            assertNotNull(annotation,
                    clazz.getSimpleName() + "." + methodName + " should be @Deprecated");
