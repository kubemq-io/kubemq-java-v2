  ...
  class DecodeTests {
    ...
    void decode_setsId() {
      Kubemq.Request proto =
          Kubemq.Request.newBuilder().setRequestID("qry-123").setChannel("test-channel").build();
    ...
    void decode_setsChannel() {
      Kubemq.Request proto =
          Kubemq.Request.newBuilder().setRequestID("qry-123").setChannel("queries-channel").build();
