...
class QueuesClientTest {
  ...
  class WaitingValidationTests {
    ...
    void waiting_zeroMaxMessages_throwsIllegalArgumentException() {
      IllegalArgumentException exception =
          assertThrows(IllegalArgumentException.class, () -> client.waiting("test-queue", 0, 5));
    ...
    void waiting_negativeMaxMessages_throwsIllegalArgumentException() {
      IllegalArgumentException exception =
          assertThrows(IllegalArgumentException.class, () -> client.waiting("test-queue", -1, 5));
      assertTrue(exception.getMessage().contains("maxMessages"));
    }
    ...
    void waiting_zeroWaitTimeout_throwsIllegalArgumentException() {
      IllegalArgumentException exception =
          assertThrows(IllegalArgumentException.class, () -> client.waiting("test-queue", 10, 0));
    ...
    void waiting_negativeWaitTimeout_throwsIllegalArgumentException() {
      IllegalArgumentException exception =
          assertThrows(IllegalArgumentException.class, () -> client.waiting("test-queue", 10, -1));
      assertTrue(exception.getMessage().contains("waitTimeoutInSeconds"));
    }
  }
  ...
  class WaitingSuccessTests {
    ...
    void waiting_serverError_returnsErrorResult() {
      Kubemq.ReceiveQueueMessagesResponse errorResponse =
          Kubemq.ReceiveQueueMessagesResponse.newBuilder()
              .setIsError(true)
    ...
    void waiting_usesPeakTrue() {
      ...
      verify(mockBlockingStub)
          .receiveQueueMessages(argThat(request -> request.getIsPeak() == true));
    }
  }
  ...
  class PullValidationTests {
    ...
    void pull_zeroMaxMessages_throwsIllegalArgumentException() {
      IllegalArgumentException exception =
          assertThrows(IllegalArgumentException.class, () -> client.pull("test-queue", 0, 5));
      assertTrue(exception.getMessage().contains("maxMessages"));
    }
    ...
    void pull_negativeMaxMessages_throwsIllegalArgumentException() {
      IllegalArgumentException exception =
          assertThrows(IllegalArgumentException.class, () -> client.pull("test-queue", -1, 5));
      assertTrue(exception.getMessage().contains("maxMessages"));
    }
    ...
    void pull_zeroWaitTimeout_throwsIllegalArgumentException() {
      IllegalArgumentException exception =
          assertThrows(IllegalArgumentException.class, () -> client.pull("test-queue", 10, 0));
      assertTrue(exception.getMessage().contains("waitTimeoutInSeconds"));
    }
    ...
    void pull_negativeWaitTimeout_throwsIllegalArgumentException() {
      IllegalArgumentException exception =
          assertThrows(IllegalArgumentException.class, () -> client.pull("test-queue", 10, -1));
      assertTrue(exception.getMessage().contains("waitTimeoutInSeconds"));
    }
  }
  ...
  class PullSuccessTests {
    ...
    void pull_usesPeakFalse() {
      ...
      verify(mockBlockingStub)
          .receiveQueueMessages(argThat(request -> request.getIsPeak() == false));
    }
  }
  ...
  class SendQueuesMessageValidationTests {
    ...
    void sendQueuesMessage_validatesMessage() {
      ...
      assertThrows(ValidationException.class, () -> client.sendQueuesMessage(invalidMessage));
    }
  }
  ...
  class ReceiveQueuesMessagesValidationTests {
    ...
    void receiveQueuesMessages_validatesRequest() {
      ...
      assertThrows(ValidationException.class, () -> client.receiveQueuesMessages(invalidRequest));
    }
  }
