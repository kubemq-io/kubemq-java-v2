...
class KubeMQExceptionTest {
    ...
    class BaseExceptionTests {
        ...
        void serialization_roundTrip() throws Exception {
            KubeMQException original = KubeMQException.newBuilder()
                .code(ErrorCode.CONNECTION_FAILED)
    ...
    class AuthenticationExceptionTests {
        ...
        @Test
        void defaultsSetCorrectly() {
            AuthenticationException ex = AuthenticationException.builder()
    ...
    class KubeMQTimeoutExceptionTests {
        ...
        @Test
        void defaultsSetCorrectly() {
            KubeMQTimeoutException ex = KubeMQTimeoutException.builder()
    ...
    class ServerExceptionTests {
        ...
        @Test
        void defaultsSetCorrectly() {
            ServerException ex = ServerException.builder()
    ...
    class ThrottlingExceptionTests {
        ...
        @Test
        void defaultsSetCorrectly() {
            ThrottlingException ex = ThrottlingException.builder()
    ...
    class HandlerExceptionTests {
        ...
        @Test
        void defaultsSetCorrectly() {
            HandlerException ex = HandlerException.builder()
                .message("Handler threw NPE")
                .build();
    ...
    class StreamBrokenExceptionTests {
        ...
        @Test
        void defaultsSetCorrectly() {
            StreamBrokenException ex = StreamBrokenException.builder()
                .message("Stream lost")
                .build();
        ...
        void unacknowledgedMessageIds_areImmutable() {
            ...
            assertThrows(UnsupportedOperationException.class, () ->
                ex.getUnacknowledgedMessageIds().add("msg-2"));
        }
    }
    ...
    class TransportExceptionTests {
        ...
        @Test
        void defaultsSetCorrectly() {
            TransportException ex = TransportException.builder()
    ...
    class BackpressureExceptionTests {
        ...
        @Test
        void defaultsSetCorrectly() {
            BackpressureException ex = BackpressureException.builder()
                .message("Buffer full")
                .build();
    ...
    class OperationCancelledExceptionTests {
        ...
        @Test
        void defaultsSetCorrectly() {
            OperationCancelledException ex = OperationCancelledException.builder()
                .message("Cancelled")
                .build();
    ...
    class RetryThrottledExceptionTests {
        ...
        @Test
        void defaultsSetCorrectly() {
            RetryThrottledException ex = RetryThrottledException.builder()
                .message("Throttled")
                .build();
    ...
    class PartialFailureExceptionTests {
        ...
        @Test
        void defaultsSetCorrectly() {
            PartialFailureException ex = PartialFailureException.builder()
        ...
        void withPerMessageErrors() {
            ...
            errors.put("msg-1", ConnectionException.builder()
        ...
        void perMessageErrors_areImmutable() {
            ...
            assertThrows(UnsupportedOperationException.class, () ->
                ex.getPerMessageErrors().put("k", null));
        }
    }
    ...
    class HierarchyTests {
        ...
        void allSubclasses_extendKubeMQException() {
            ...
            assertInstanceOf(KubeMQException.class, AuthenticationException.builder().message("t").build());
            assertInstanceOf(KubeMQException.class, AuthorizationException.builder().message("t").build());
            assertInstanceOf(KubeMQException.class, KubeMQTimeoutException.builder().message("t").build());
            ...
            assertInstanceOf(KubeMQException.class, OperationCancelledException.builder().message("t").build());
            assertInstanceOf(KubeMQException.class, RetryThrottledException.builder().message("t").build());
            assertInstanceOf(KubeMQException.class, PartialFailureException.builder().message("t").build());
        }
        ...
        void allSubclasses_extendRuntimeException() {
            ...
            assertInstanceOf(RuntimeException.class, AuthenticationException.builder().message("t").build());
            assertInstanceOf(RuntimeException.class, KubeMQTimeoutException.builder().message("t").build());
        }
