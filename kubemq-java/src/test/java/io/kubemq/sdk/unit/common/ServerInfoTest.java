...
class ServerInfoTest {
  ...
  class BuilderTests {
    ...
    void builder_withMinimalFields_createsServerInfo() {
      ServerInfo info = ServerInfo.builder().host("localhost").build();
  ...
  class ToStringTests {
    ...
    void toString_withNullHost_handlesGracefully() {
      ServerInfo info = ServerInfo.builder().version("1.0.0").build();
    ...
    void toString_withNullVersion_handlesGracefully() {
      ServerInfo info = ServerInfo.builder().host("test-host").build();
  ...
  class VersionParsingTests {
    ...
    void version_withSemanticVersioning_storesCorrectly() {
      ServerInfo info = ServerInfo.builder().host("test").version("2.3.4-beta.1").build();
    ...
    void version_withMajorVersionOnly_storesCorrectly() {
      ServerInfo info = ServerInfo.builder().host("test").version("3").build();
    ...
    void version_withSpecialCharacters_storesCorrectly() {
      ServerInfo info = ServerInfo.builder().host("test").version("v2.0.0-rc1+build.123").build();
  ...
  class HostFormatTests {
    ...
    void host_withPort_storesCorrectly() {
      ServerInfo info = ServerInfo.builder().host("192.168.1.100:50000").version("1.0.0").build();
    ...
    void host_withHostname_storesCorrectly() {
      ServerInfo info =
          ServerInfo.builder().host("kubemq.production.cluster.local").version("1.0.0").build();
    ...
    void host_withIPv6_storesCorrectly() {
      ServerInfo info = ServerInfo.builder().host("[::1]:50000").version("1.0.0").build();
