...
class InternalAnnotationTest {
  ...
  void queueUpstreamHandlerIsInternal() {
    assertTrue(
        QueueUpstreamHandler.class.isAnnotationPresent(Internal.class),
  ...
  void queueDownstreamHandlerIsInternal() {
    assertTrue(
        QueueDownstreamHandler.class.isAnnotationPresent(Internal.class),
  ...
  void eventStreamHelperIsInternal() {
    assertTrue(
        EventStreamHelper.class.isAnnotationPresent(Internal.class),
  ...
  void channelDecoderIsInternal() {
    assertTrue(
        ChannelDecoder.class.isAnnotationPresent(Internal.class),
  ...
  void kubeMQUtilsIsDeprecatedAndInternal() {
    assertTrue(
        KubeMQUtils.class.isAnnotationPresent(Internal.class), "KubeMQUtils should be @Internal");
    assertTrue(
        KubeMQUtils.class.isAnnotationPresent(Deprecated.class),
