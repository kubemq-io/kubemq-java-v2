...
/**
 * Unit tests for KubeMQUtils utility class. Tests cover all channel operations including create,
 * delete, and list.
 */
...
class KubeMQUtilsTest {
  ...
  class CreateChannelTests {
    ...
    void createChannel_notExecuted_throwsCreateChannelException() {
      ...
      CreateChannelException exception =
          assertThrows(
              CreateChannelException.class,
              () -> {
                KubeMQUtils.createChannelRequest(
                    mockClient, "test-client", "test-channel", "queues");
              });
    ...
    void createChannel_differentTypes_works() {
      ...
      assertTrue(
          KubeMQUtils.createChannelRequest(mockClient, "test-client", "test-channel", "events"));
      assertTrue(
          KubeMQUtils.createChannelRequest(
              mockClient, "test-client", "test-channel", "events_store"));
      assertTrue(
          KubeMQUtils.createChannelRequest(mockClient, "test-client", "test-channel", "commands"));
      assertTrue(
          KubeMQUtils.createChannelRequest(mockClient, "test-client", "test-channel", "queries"));
    }
  }
  ...
  class DeleteChannelTests {
    ...
    void deleteChannel_notExecuted_throwsDeleteChannelException() {
      ...
      DeleteChannelException exception =
          assertThrows(
              DeleteChannelException.class,
              () -> {
                KubeMQUtils.deleteChannelRequest(
                    mockClient, "test-client", "test-channel", "queues");
              });
  ...
  class ListQueuesChannelsTests {
    ...
    void listQueuesChannels_success_returnsChannelList() {
      ...
      String jsonResponse =
          "[{\"name\":\"queue1\",\"type\":\"queues\",\"lastActivity\":1234567890,\"isActive\":true,\"incoming\":{\"messages\":100,\"volume\":1024,\"waiting\":10},\"outgoing\":{\"messages\":90,\"volume\":900,\"waiting\":0}}]";

      Kubemq.Response successResponse =
          Kubemq.Response.newBuilder()
              .setExecuted(true)
    ...
    void listQueuesChannels_notExecuted_throwsListChannelsException() {
      ...
      ListChannelsException exception =
          assertThrows(
              ListChannelsException.class,
              () -> {
    ...
    void listQueuesChannels_grpcError_throwsGRPCException() {
      ...
      assertThrows(
          io.kubemq.sdk.exception.KubeMQException.class,
          () -> {
            KubeMQUtils.listQueuesChannels(mockClient, "test-client", "");
          });
    }
    ...
    void listQueuesChannels_withSearch_passesFilter() {
      ...
      List<QueuesChannel> result =
          KubeMQUtils.listQueuesChannels(mockClient, "test-client", "test-filter");
  ...
  class ListPubSubChannelsTests {
    ...
    void listPubSubChannels_success_returnsChannelList() {
      String jsonResponse =
          "[{\"name\":\"events1\",\"type\":\"events\",\"lastActivity\":1234567890,\"isActive\":true,\"incoming\":{\"messages\":100,\"volume\":1024,\"waiting\":0},\"outgoing\":{\"messages\":100,\"volume\":1024,\"waiting\":0}}]";
    ...
    void listPubSubChannels_nullSearch_usesEmptyString() {
      ...
      List<PubSubChannel> result =
          KubeMQUtils.listPubSubChannels(mockClient, "test-client", "events", null);
  ...
  class ListCQChannelsTests {
    ...
    void listCQChannels_success_returnsChannelList() {
      String jsonResponse =
          "[{\"name\":\"commands1\",\"type\":\"commands\",\"lastActivity\":1234567890,\"isActive\":true,\"incoming\":{\"messages\":100,\"volume\":1024,\"waiting\":0},\"outgoing\":{\"messages\":100,\"volume\":1024,\"waiting\":0}}]";
    ...
    void listCQChannels_nullSearch_usesEmptyString() {
      ...
      List<CQChannel> result =
          KubeMQUtils.listCQChannels(mockClient, "test-client", "commands", null);
    ...
    void listQueriesChannels_success_returnsChannelList() {
      String jsonResponse =
          "[{\"name\":\"queries1\",\"type\":\"queries\",\"lastActivity\":1234567890,\"isActive\":true,\"incoming\":{\"messages\":50,\"volume\":512,\"waiting\":0},\"outgoing\":{\"messages\":50,\"volume\":512,\"waiting\":0}}]";
