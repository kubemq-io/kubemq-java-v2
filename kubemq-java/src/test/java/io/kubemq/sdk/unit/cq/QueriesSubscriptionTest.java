...
class QueriesSubscriptionTest {
  ...
  class ValidationTests {
    ...
    void validate_withNullChannel_throws() {
      QueriesSubscription subscription =
          QueriesSubscription.builder().onReceiveQueryCallback(qry -> {}).build();
    ...
    void validate_withEmptyChannel_throws() {
      QueriesSubscription subscription =
          QueriesSubscription.builder().channel("").onReceiveQueryCallback(qry -> {}).build();
    ...
    void validate_withNullCallback_throws() {
      QueriesSubscription subscription =
          QueriesSubscription.builder().channel("test-channel").build();
