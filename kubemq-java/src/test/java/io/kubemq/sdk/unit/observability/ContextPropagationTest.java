...
class ContextPropagationTest {
    ...
    void injectAddsTraceparent() {
        ...
        try (AutoCloseable scope = tracing.makeCurrent(spanObj)) {
            ...
            assertTrue(tags.containsKey("traceparent"),
                    "traceparent should be injected into tags");
    ...
    void roundTripInjectExtract() {
        ...
        assertFalse(consumer.getLinks().isEmpty(),
                "Consumer span should have a link to producer");
        assertEquals(spans.get(0).getTraceId(),
