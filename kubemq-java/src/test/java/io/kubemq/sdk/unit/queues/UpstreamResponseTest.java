...
class UpstreamResponseTest {
  ...
  class BuilderTests {
    ...
    void builder_withDefaultResults_initializesToEmptyList() {
      UpstreamResponse response = UpstreamResponse.builder().refRequestId("ref-default").build();
    ...
    void builder_withNoResults_createsEmptyList() {
      UpstreamResponse response =
          UpstreamResponse.builder().refRequestId("ref-empty").isError(false).build();
  ...
  class GetterSetterTests {
    ...
    void setResults_updatesResults() {
      UpstreamResponse response = UpstreamResponse.builder().build();
      List<QueueSendResult> results =
          Arrays.asList(QueueSendResult.builder().id("new-result").build());
  ...
  class ToStringTests {
    ...
    void toString_includesAllFields() {
      List<QueueSendResult> results =
          Arrays.asList(QueueSendResult.builder().id("result-str").isError(false).build());
    ...
    void toString_withEmptyResults_handlesGracefully() {
      UpstreamResponse response = UpstreamResponse.builder().refRequestId("ref-empty").build();
  ...
  class ResultsManagementTests {
    ...
    void multipleResults_areStoredCorrectly() {
      ...
      UpstreamResponse response =
          UpstreamResponse.builder().refRequestId("multi-results").results(results).build();
