...
class QueueMessageTest {
  ...
  class ValidationTests {
    ...
    void validate_withValidMessage_passes() {
      QueueMessage msg =
          QueueMessage.builder().channel("test-channel").body("test body".getBytes()).build();
    ...
    void validate_withMetadataOnly_passes() {
      QueueMessage msg =
          QueueMessage.builder().channel("test-channel").metadata("test metadata").build();
    ...
    void validate_withTagsOnly_passes() {
      ...
      QueueMessage msg = QueueMessage.builder().channel("test-channel").tags(tags).build();
    ...
    void validate_withNullChannel_throws() {
      QueueMessage msg = QueueMessage.builder().body("test".getBytes()).build();
    ...
    void validate_withEmptyChannel_throws() {
      QueueMessage msg = QueueMessage.builder().channel("").body("test".getBytes()).build();
    ...
    void validate_withNoContent_throws() {
      QueueMessage msg = QueueMessage.builder().channel("test-channel").build();
  ...
  class EncodingTests {
    ...
    void encodeMessage_setsClientId() {
      QueueMessage msg =
          QueueMessage.builder().channel("test-channel").body("test".getBytes()).build();
    ...
    void encodeMessage_setsChannel() {
      QueueMessage msg = QueueMessage.builder().channel("orders").body("test".getBytes()).build();
    ...
    void encodeMessage_setsBody() {
      ...
      QueueMessage msg = QueueMessage.builder().channel("test-channel").body(body).build();
    ...
    void encodeMessage_setsTags() {
      ...
      QueueMessage msg =
          QueueMessage.builder().channel("test-channel").body("test".getBytes()).tags(tags).build();
  ...
  class DecodingTests {
    ...
    void decode_handlesEmptyFields() {
      Kubemq.QueueMessage proto =
          Kubemq.QueueMessage.newBuilder().setMessageID("msg-123").setChannel("test").build();
  ...
  class RoundTripTests {
    ...
    void encodeAndDecode_preservesAllFields() {
      ...
      assertEquals(
          original.getAttemptsBeforeDeadLetterQueue(), decoded.getAttemptsBeforeDeadLetterQueue());
    ...
    void encodeAndDecode_withMinimalMessage() {
      QueueMessage original =
          QueueMessage.builder().channel("test").body("data".getBytes()).build();
