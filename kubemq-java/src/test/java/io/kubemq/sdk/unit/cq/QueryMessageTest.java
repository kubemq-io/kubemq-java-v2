...
class QueryMessageTest {
  ...
  class ValidationTests {
    ...
    void validate_withTagsOnly_passes() {
      ...
      QueryMessage msg =
          QueryMessage.builder().channel("test-channel").tags(tags).timeoutInSeconds(30).build();
    ...
    void validate_withNullChannel_throws() {
      QueryMessage msg =
          QueryMessage.builder().body("test".getBytes()).timeoutInSeconds(30).build();
    ...
    void validate_withEmptyChannel_throws() {
      QueryMessage msg =
          QueryMessage.builder().channel("").body("test".getBytes()).timeoutInSeconds(30).build();
    ...
    void validate_withNoContent_throws() {
      QueryMessage msg =
          QueryMessage.builder().channel("test-channel").timeoutInSeconds(30).build();
  ...
  class EncodingTests {
    ...
    void encode_setsBody() {
      ...
      QueryMessage msg =
          QueryMessage.builder().channel("test-channel").body(body).timeoutInSeconds(30).build();
