...
/**
 * Tests for KubeMQLogger interface contract: verifies custom implementations work correctly
 * and that the user-injectable logger pattern functions as expected.
 */
class KubeMQLoggerInterfaceTest {
    ...
    void customLoggerReceivesCalls() {
        ...
        KubeMQLogger custom = new KubeMQLogger() {
            @Override public void trace(String msg, Object... kv) { messages.add("TRACE:" + msg); }
            @Override public void debug(String msg, Object... kv) { messages.add("DEBUG:" + msg); }
            @Override public void info(String msg, Object... kv) { messages.add("INFO:" + msg); }
            @Override public void warn(String msg, Object... kv) { messages.add("WARN:" + msg); }
            @Override public void error(String msg, Object... kv) { messages.add("ERROR:" + msg); }
            @Override public void error(String msg, Throwable cause, Object... kv) {
    ...
    void customLoggerReceivesKeyValuePairs() {
        ...
        KubeMQLogger custom = new KubeMQLogger() {
            @Override public void trace(String msg, Object... kv) { captured.add(kv); }
            @Override public void debug(String msg, Object... kv) { captured.add(kv); }
            @Override public void info(String msg, Object... kv) { captured.add(kv); }
            @Override public void warn(String msg, Object... kv) { captured.add(kv); }
            @Override public void error(String msg, Object... kv) { captured.add(kv); }
            @Override public void error(String msg, Throwable cause, Object... kv) { captured.add(kv); }
            @Override public boolean isEnabled(LogLevel level) { return true; }
        };
    ...
    void isEnabledSelectivelyReturnsTrue() {
        KubeMQLogger custom = new KubeMQLogger() {
            @Override public void trace(String msg, Object... kv) {}
            ...
            @Override public void error(String msg, Throwable cause, Object... kv) {}
            @Override public boolean isEnabled(LogLevel level) {
